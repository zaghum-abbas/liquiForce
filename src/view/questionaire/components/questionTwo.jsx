...
const QuestionTwo = ({ title, options, questionTitle, questionBody }) => {
    ...
    <>
      ...
      <CardContent className="md:flex md:justify-between  flex-wrap block gap-y-4">
        {options.map((item, index) => (
          <Card
            className={cn(
              "md:w-[299px] md:mb-0 mb-4 md:rounded-[8px] rounded-[8px] md:p-4 px-4 py-3 flex md:flex-col max-md:gap-[10px] items-center md:justify-center justify-start cursor-pointer",
