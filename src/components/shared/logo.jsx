...
export const BlueLogo = () => {
  return (
    <div className="max-md:hidden flex md:max-w-[193px] max-w-[160px] xl:mt-[60px]  xl:ml-[80px] lg:mt-[50px] lg:ml-[60px] md:mt-[40px] md:ml-[50px] max-md:self-center max-md:mt-[100px] ">
      <Image
